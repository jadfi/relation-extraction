...
parser.add_argument('--att_loss_weight', type=float, default=0, help='weight of attention loss')
...
parser.add_argument('--embed_dim',type=int,help='embedding dimension of word')
parser.add_argument('--entity_dim',type=int, default=3, help='embedding dimension for entity position')
parser.add_argument('--enc_dim',type=int,default=512, help='rnn cell size;cnn kernel number')
...
if args.dataset == 'naacl':
    ...
    loader = mimlLoader(relation_file = '../data/data/rel2ind.pkl',
                        train_file = '../data/data/nyt_train.pkl',
                        test_file='../data/data/nyt_test.pkl',
                        embed_dir = '../data/data/embed.pkl',
                        n_vocab = args.vocab_size,
                        max_len = args.L)
...
model = Model(bag_num = args.bag_num,
              ...
              att_loss_weight = args.att_loss_weight / 10.0,
